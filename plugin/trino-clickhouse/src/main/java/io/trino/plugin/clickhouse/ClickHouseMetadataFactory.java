...
/**
 * Builds {@link ClickHouseMetadata} (instead of the default JDBC metadata) so MERGE uses the ClickHouse row-change
 * paradigm. Bound in place of the default factory by {@link ClickHouseClientModule}.
 */
        ...
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public ClickHouseMetadataFactory(
    ...
    {
        return new ClickHouseMetadata(transactionCachingJdbcClient, timestampTimeZoneDomain, true, jdbcQueryEventListeners);
    }
}
